...
// requireAuth()/requireSuperAdmin(), sendJson()/sendError(), getJsonInput() and logAudit().
...
if ($method === 'GET') {
    ...
    // 1. Units sold on this date (paid bills only, keyed to the moment of
    //    settlement rather than bill creation).
    $soldQuery = "
    ...
    //    stock_in / purchase and positive adjustments count as "received";
    //    negative adjustments are subtracted from the opening (in-hand) figure.
    $movQuery = "
